...
export const STATUS_COLORS: { [key in CalendarStatus]: { bg: string; text: string; border: string } } = {
  ...
  booked: { bg: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-200' },
  blocked: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
  owner: { bg: 'bg-fuchsia-50', text: 'text-fuchsia-700', border: 'border-fuchsia-200' },
};
