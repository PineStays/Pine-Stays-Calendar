...
class DatabaseService {
  ...
  private async checkAndSeedDatabase() {
    ...
    const properties: Omit<Property, 'id'>[] = [
      {
        propertyCode: 'LNV-B4-ABCD', name: 'The Glass House', type: 'Villa', location: 'Lonavala', capacity: 8, maxCapacity: 12, bedrooms: 4, bathrooms: 4, area: '4500 sq ft', poolType: 'private', basePrice: 25000, photoLink: 'https://images.unsplash.com/photo-1613977257363-311617c0938f?q=80&w=2070&auto=format&fit=crop', pdfLink: '#', amenities: ['Pool', 'WiFi', 'AC', 'Kitchen', 'Parking', 'Garden'], description: 'A stunning modern villa with panoramic views, perfect for a luxurious getaway.', status: 'active', ownerId: '', extraGuestCost: 2000, houseRules: 'No loud music after 10 PM. No pets allowed.'
      },
      {
        propertyCode: 'GOA-B5-EFGH', name: 'Casa Sol', type: '5-BHK', location: 'Goa', capacity: 10, maxCapacity: 15, bedrooms: 5, bathrooms: 5, area: '6000 sq ft', poolType: 'private', basePrice: 40000, photoLink: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=1974&auto=format&fit=crop', pdfLink: '#', amenities: ['Pool', 'WiFi', 'AC', 'Kitchen', 'Parking', 'Garden', 'TV'], description: 'Experience beachfront bliss in this spacious and elegant Goan villa.', status: 'active', ownerId: ''
      },
      {
        propertyCode: 'ALI-B3-IJKL', name: 'The Frangipani', type: '3-BHK', location: 'Alibaug', capacity: 6, maxCapacity: 8, bedrooms: 3, bathrooms: 3, area: '3000 sq ft', poolType: 'shared', basePrice: 18000, photoLink: 'https://images.unsplash.com/photo-1598228723793-52759bba239c?q=80&w=1974&auto=format&fit=crop', pdfLink: '#', amenities: ['Pool', 'WiFi', 'AC', 'Kitchen', 'Parking'], description: 'A charming and cozy retreat surrounded by lush greenery.', status: 'active'
      },
    ];
